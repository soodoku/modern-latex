...
Adobe's original claim to fame,
...
they are not the only ones you will ever want to use.
...
\item[Standard] ligatures remedy spacing problems between certain characters.
    ...
    awkward spacing between the f's ascender and the i's dot
...
Ligatures can also be disabled with the corresponding \verb|*Off|
